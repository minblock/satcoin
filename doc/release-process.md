...
* Update manpages, see [gen-manpages.sh](https://github.com/satellite-project/satellite/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
- Detached signatures will then be committed to the [satellite-detached-sigs](https://github.com/satellite-project/satellite-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/satellite-project/satellite/releases/new) with a link to the archived release notes.
