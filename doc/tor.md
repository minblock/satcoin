# TOR SUPPORT IN SATELLITECOIN

It is possible to run Satellitecoin Core as a Tor hidden service, and connect to such services.
...
your satellitecoind's P2P listen port (6666 by default).

	-externalip=X   You can tell satellitecoin about its publicly reachable address using
...
In a typical situation, where you're only reachable via Tor, this should suffice:
	...
	./satellitecoind -proxy=127.0.0.1:9050 -externalip=57qr3yd1nyntf5k.onion -listen
...
for normal IPv4/IPv6 communication, use:
	...
	./satellitecoind -onion=127.0.0.1:9050 -externalip=57qr3yd1nyntf5k.onion -discover
...
Satellitecoin Core automatically creates a hidden service to listen on. This will positively
...
- Do not add anything but Satellitecoin Core ports to the hidden service created in section 2.
