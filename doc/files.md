...
* satcoin.conf: contains configuration settings for satcoind or satcoin-qt
* satcoind.pid: stores the process id of satcoind while running
...
* debug.log: contains debug information and general logging generated by satcoind or satcoin-qt
