...
* satellite.conf: contains configuration settings for satellited or satellite-qt
* satellited.pid: stores the process id of satellited while running
...
* debug.log: contains debug information and general logging generated by satellited or satellite-qt
