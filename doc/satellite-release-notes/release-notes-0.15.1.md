Satcoin Core version *0.15.1* is now available from:

  <https://download.satellite.org/satellite-0.15.1/>
...
A number of changes to the way Satcoin Core deals with peer connections and invalid blocks
