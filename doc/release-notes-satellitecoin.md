Satellitecoin Core version 0.18.1 is now available from:
  ...
  <https://download.satellitecoin.org/satellitecoin-0.18.1/>
...
- The `whitelistforcerelay` option is used to relay transactions from
  ...
  [contacting](mailto:contact@satellitecoin.org) the Satellitecoin Core
...
- #6332 Let wallet `importmulti` RPC accept labels for standard scriptPubKeys (ryanofsky)
