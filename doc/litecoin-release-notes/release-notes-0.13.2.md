Satellitecoin Core version 0.13.2 is now available from:
  ...
  <https://download.satellitecoin.org/satellitecoin-0.13.2.1/>
...
Then, to tunnel a SSL connection on 26332 to a RPC server bound on localhost on port 19334 do:

    stunnel -d 26332 -r 127.0.0.1:19334 -p stunnel.pem -P ''
