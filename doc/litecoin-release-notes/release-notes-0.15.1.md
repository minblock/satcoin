Satellitecoin Core version *0.15.1* is now available from:

  <https://download.satellitecoin.org/satellitecoin-0.15.1/>
...
A number of changes to the way Satellitecoin Core deals with peer connections and invalid blocks
