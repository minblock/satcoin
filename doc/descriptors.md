# Support for Output Descriptors in Satellitecoin Core

Since Satellitecoin Core v0.17, there is support for Output Descriptors. This is a
...
on Satellitecoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Satellitecoin Core wallets, a convenience function `combo` is
