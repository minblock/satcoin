# Support for Output Descriptors in Satcoin Core

Since Satcoin Core v0.17, there is support for Output Descriptors in the
...
- Segwit addresses (bech32, of the form `stc1...`, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Satcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Satcoin Core wallets, a convenience function `combo` is
