...
def setup():
    ...
    if not os.path.isdir('satellitecoin-detached-sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/minblock/satellitecoin-detached-sigs.git'])
...
def build():
    ...
    if args.linux:
        ...
        subprocess.check_call(['bin/gsign', '-p', args.sign_prog, '--signer', args.signer, '--release', args.version+'-linux', '--destination', '../gitian.sigs.ltc/', '../satellitecoin/contrib/gitian-descriptors/gitian-linux.yml'])
    ...
    if args.windows:
        ...
        subprocess.check_call(['bin/gsign', '-p', args.sign_prog, '--signer', args.signer, '--release', args.version+'-win-unsigned', '--destination', '../gitian.sigs.ltc/', '../satellitecoin/contrib/gitian-descriptors/gitian-win.yml'])
        subprocess.check_call('mv build/out/satellitecoin-*-win-unsigned.tar.gz inputs/', shell=True)
        subprocess.check_call('mv build/out/satellitecoin-*.zip build/out/satellitecoin-*.exe ../satellitecoin-binaries/'+args.version, shell=True)
    ...
    if args.macos:
        ...
        subprocess.check_call(['bin/gsign', '-p', args.sign_prog, '--signer', args.signer, '--release', args.version+'-osx-unsigned', '--destination', '../gitian.sigs.ltc/', '../satellitecoin/contrib/gitian-descriptors/gitian-osx.yml'])
        subprocess.check_call('mv build/out/satellitecoin-*-osx-unsigned.tar.gz inputs/', shell=True)
        subprocess.check_call('mv build/out/satellitecoin-*.tar.gz build/out/satellitecoin-*.dmg ../satellitecoin-binaries/'+args.version, shell=True)
...
def sign():
    ...
    if args.windows:
        ...
        subprocess.check_call(['bin/gbuild', '-i', '--commit', 'signature='+args.commit, '../satellitecoin/contrib/gitian-descriptors/gitian-win-signer.yml'])
        subprocess.check_call(['bin/gsign', '-p', args.sign_prog, '--signer', args.signer, '--release', args.version+'-win-signed', '--destination', '../gitian.sigs.ltc/', '../satellitecoin/contrib/gitian-descriptors/gitian-win-signer.yml'])
        subprocess.check_call('mv build/out/satellitecoin-*win64-setup.exe ../satellitecoin-binaries/'+args.version, shell=True)
        subprocess.check_call('mv build/out/satellitecoin-*win32-setup.exe ../satellitecoin-binaries/'+args.version, shell=True)
    ...
    if args.macos:
        ...
        subprocess.check_call(['bin/gbuild', '-i', '--commit', 'signature='+args.commit, '../satellitecoin/contrib/gitian-descriptors/gitian-osx-signer.yml'])
        subprocess.check_call(['bin/gsign', '-p', args.sign_prog, '--signer', args.signer, '--release', args.version+'-osx-signed', '--destination', '../gitian.sigs.ltc/', '../satellitecoin/contrib/gitian-descriptors/gitian-osx-signer.yml'])
...
def verify():
    ...
    subprocess.check_call(['bin/gverify', '-v', '-d', '../gitian.sigs.ltc/', '-r', args.version+'-linux', '../satellitecoin/contrib/gitian-descriptors/gitian-linux.yml'])
    print('\nVerifying v'+args.version+' Windows\n')
    subprocess.check_call(['bin/gverify', '-v', '-d', '../gitian.sigs.ltc/', '-r', args.version+'-win-unsigned', '../satellitecoin/contrib/gitian-descriptors/gitian-win.yml'])
    print('\nVerifying v'+args.version+' MacOS\n')
    subprocess.check_call(['bin/gverify', '-v', '-d', '../gitian.sigs.ltc/', '-r', args.version+'-osx-unsigned', '../satellitecoin/contrib/gitian-descriptors/gitian-osx.yml'])
    print('\nVerifying v'+args.version+' Signed Windows\n')
    subprocess.check_call(['bin/gverify', '-v', '-d', '../gitian.sigs.ltc/', '-r', args.version+'-win-signed', '../satellitecoin/contrib/gitian-descriptors/gitian-win-signer.yml'])
    print('\nVerifying v'+args.version+' Signed MacOS\n')
    subprocess.check_call(['bin/gverify', '-v', '-d', '../gitian.sigs.ltc/', '-r', args.version+'-osx-signed', '../satellitecoin/contrib/gitian-descriptors/gitian-osx-signer.yml'])
