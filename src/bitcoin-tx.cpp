...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " satellitecoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  satellitecoin-tx [options] <hex-tx> [commands]  Update hex-encoded satellitecoin transaction\n" +
            "or:     satellitecoin-tx [options] -create [commands]   Create hex-encoded satellitecoin transaction\n" +
            "\n";
