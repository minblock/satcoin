...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s satellite-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  satellite-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded satellite transaction") + "\n" +
              "  satellite-tx [options] -create [commands]   " + _("Create hex-encoded satellite transaction") + "\n" +
              "\n";
