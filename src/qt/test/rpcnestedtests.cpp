...
void RPCNestedTests::rpcNestedTests()
{
    ...
    ClearDatadirCache();
    std::string path = QDir::tempPath().toStdString() + "/" + strprintf("test_satellite_qt_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
    ...
    QVERIFY(result == "6ff7456ab0c79d9d8f984d1863cfc89b2f0475954d2ae67c76c38f7fdd19a174");
