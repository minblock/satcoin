...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and satcoin: URIs)"));
    ...
    openAction->setStatusTip(tr("Open a satcoin: URI or payment request"));
