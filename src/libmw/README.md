...
Modular library for supporting Satellitecoin's implementation of the MWEB (Mimblewimble Extension Block). 
...
and just replace the more-limited secp256k1 dependency that's already included in Satellitecoin.
