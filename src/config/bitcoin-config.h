...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Satellitecoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Satellitecoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/minblock/satellitecoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Satellitecoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Satellitecoin Core 0.21.2.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "satellitecoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://provgn.com/"

/* Define to the version of this package. */
#define PACKAGE_VERSION "0.21.2.1"
