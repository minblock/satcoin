...
public:
    CMainParams() {
        ...
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.satellite.loshan.co.uk", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("satellitetools.com", "dnsseed.satellitetools.com"));
        //vSeeds.push_back(CDNSSeedData("satellitepool.org", "dnsseed.satellitepool.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  150000, uint256S("0x841a2965955dd288cfa707a755d05a54e45f8bd476835ec9af4402a2b59a2967"))
        };
...
public:
    CTestNetParams() {
        ...
        //vSeeds.push_back(CDNSSeedData("satellitetools.com", "testnet-seed.satellitetools.com"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.satellite.loshan.co.uk", true));
