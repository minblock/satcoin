...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 0.5 * 24 * 60 * 60; // 12 hours
        ...
        consensus.defaultAssumeValid = uint256S("0xd5ea20e98548d4d56832c4b77630ccda88066e89adcf826565f6f683c107f854"); //-1
