...
#if defined(NDEBUG)
# error "Satellitecoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Satellitecoin Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("satellitecoin-scriptch");
