...
"""Verify that starting satellite with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start satellite with -h for help text")
        ...
        self.log.info("Start satellite with -version for version information")
        ...
        self.log.info("Start satellited with -fakearg to make sure it does not start")
