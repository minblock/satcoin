...
"""Verify that starting satcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start satcoin with -h for help text")
        ...
        self.log.info("Start satcoin with -version for version information")
        ...
        self.log.info("Start satcoind with -fakearg to make sure it does not start")
