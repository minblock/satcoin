...
"""Verify that starting satellitecoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start satellitecoin with -h for help text")
        ...
        self.log.info("Start satellitecoin with -version for version information")
        ...
        self.log.info("Start satellitecoind with -fakearg to make sure it does not start")
